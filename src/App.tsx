...
function AppInner() {
    ...
    return (
      <div className="min-h-screen bg-[#F7F7F5] flex items-center justify-center">
        <div className="animate-pulse">
          <Flame size={48} className="text-[#16A34A]" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F5] flex flex-col items-center justify-center px-4 relative">
      <button
        onClick={() => setMode('adm')}
      ...
      <div className="w-full max-w-sm">
        <button
          ...
          className="group w-full bg-[#16A34A] hover:bg-[#f6121d] text-white font-bold text-lg py-6 rounded-2xl transition-all hover:shadow-lg hover:shadow-red-900/20 hover:-translate-y-0.5 active:scale-95 flex flex-col items-center gap-1.5"
        >
          <Flame size={26} />
