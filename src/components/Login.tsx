        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-3.5 text-neutral-900 text-lg focus:border-[#16A34A] focus:outline-none transition-colors"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#16A34A] hover:bg-[#f6121d] text-white font-bold text-lg py-4 rounded-xl transition-colors disabled:opacity-50 active:scale-[0.98]"
          >
