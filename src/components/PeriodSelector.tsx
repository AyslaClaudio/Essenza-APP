      ...
      {showCustom && (
        <div className="bg-neutral-100/50 border border-neutral-200 rounded-xl p-4 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-neutral-100 border border-neutral-200 rounded-lg px-3 py-2 text-neutral-900 focus:border-[#DC2626] focus:outline-none text-sm"
              />
            </div>
            <div>
          ...
          <button
            ...
            className="w-full bg-[#DC2626] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#f6121d] active:scale-95"
          >
            Aplicar Período
          </button>
        </div>
