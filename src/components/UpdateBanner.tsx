  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-3 bg-neutral-900 text-white px-4 py-3 rounded-2xl shadow-2xl max-w-[92vw]">
      ...
      <button
        ...
        className="flex items-center gap-1.5 bg-[#F26522] hover:bg-red-600 text-white text-sm font-bold px-3 py-1.5 rounded-xl whitespace-nowrap transition-colors"
      >
