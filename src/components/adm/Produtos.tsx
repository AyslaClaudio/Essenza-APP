    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-4 py-2 rounded-xl text-sm font-medium ${tab === 'produtos' ? 'bg-[#E50914] text-white' : 'bg-neutral-200 text-neutral-500'}`}
        >Produtos</button>
        <button
          onClick={() => setTab('adicionais')}
          className={`px-4 py-2 rounded-xl text-sm font-medium ${tab === 'adicionais' ? 'bg-[#E50914] text-white' : 'bg-neutral-200 text-neutral-500'}`}
        ...
        <>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <select
              ...
              className="bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 text-sm focus:border-[#E50914] focus:outline-none"
            >
        ...
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" onClick={() => setUnlockModal(false)}>
          <div className="bg-white border border-neutral-200 rounded-2xl p-6 w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
            ...
            <input
              ...
              className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-3 text-neutral-900 mb-4 focus:border-[#E50914] focus:outline-none"
              autoFocus
            />
            <div className="flex gap-2">
      ...
      <div className="bg-white border border-neutral-200 rounded-2xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <select value={categoria} onChange={(e) => setCategoria(e.target.value)} className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 mt-1 focus:border-[#E50914] focus:outline-none">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="number" step="0.01" value={preco} onChange={(e) => setPreco(e.target.value)} className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 mt-1 focus:border-[#E50914] focus:outline-none" />
            </div>
          </div>
          <div>
            ...
            <div className="mt-1 flex items-center gap-3">
              <label className={`flex-1 flex items-center justify-center gap-2 bg-neutral-100 border-2 border-dashed border-neutral-200 rounded-xl px-4 py-3 text-neutral-500 text-sm cursor-pointer hover:border-[#E50914] hover:text-neutral-900 transition-colors ${uploading ? 'opacity-50 pointer-events-none' : ''}`}>
                {uploading ? (
            ...
            {/* URL input (manual) */}
            <input value={foto} onChange={(e) => setFoto(e.target.value)} placeholder="ou cole uma URL de imagem..." className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 mt-2 focus:border-[#E50914] focus:outline-none text-sm" />
          ...
          <div>
            ...
            <input value={tamanho} onChange={(e) => setTamanho(e.target.value)} placeholder="P, G, Esfirra..." className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 mt-1 focus:border-[#E50914] focus:outline-none" />
          </div>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white border border-neutral-200 rounded-2xl p-6 w-full max-w-sm" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          <input value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Nome (ex: Borda Catupiry)" className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 focus:border-[#E50914] focus:outline-none" />
          <input type="number" step="0.01" value={preco} onChange={(e) => setPreco(e.target.value)} placeholder="Preço (R$)" className="w-full bg-neutral-100 border border-neutral-200 rounded-xl px-4 py-2.5 text-neutral-900 focus:border-[#E50914] focus:outline-none" />
        </div>
        <div className="flex gap-2 mt-5">
